	...
	var install = function install(Vue) {
	  ...
	  var getReq = function getReq(url, query) {
	    ...
	    Vue.http.get(spellUrl(url, query), headers).then(function (data) {
	      ...
	      return _promise2.default.reject(err.data);
	    });
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonUtil = __webpack_require__(11);
	...
	module.exports = {
	  ...
	  methods: {
	    submit: function submit() {
	      var passwd = _commonUtil2.default.encryptPassword('15169122789', 'amen@1991'),
	          url = _vue2.default.constants.AUTH;
	      alert(passwd);
	      _vue2.default.postReq(url, { phoneNum: '15169122789', password: passwd }).then(function (data) {
	        console.log(data);
	      }, function (err) {
	        console.log(err);
	      });
